...
WantedBy=multi-user.target
EOF
wget https://raw.githubusercontent.com/rajaganjil93/hss/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/rajaganjil93/hss/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
